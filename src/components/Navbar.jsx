    ...
    <>
      <nav className="sticky top-0 w-full h-[50px] px-5 md:px-8 py-8 flex justify-between items-center z-10 bg-white">
        <div className="flex items-center gap-x-3">
          <img className="w-[40px] h-[40px]" src={Logo} alt="FarmFolio Logo" />
          <h2 className="font-bold text-[#6cb770]">FarmFolio</h2>
        </div>
        <ul className="hidden items-center md:flex">
          <li className="ml-8 font-semibold hover:text-[#009861] cursor-pointer">Home</li>
          <li className="ml-8 font-semibold hover:text-[#009861] cursor-pointer">Crops</li>
          <li className="ml-8 font-semibold hover:text-[#009861] cursor-pointer">Team</li>
        </ul>
        {!nav ? (
      ...
      >
        <li className="font-semibold hover:text-[#009861] cursor-pointer mb-5 flex-nav-links ">
          <AiFillHome /> Home
        </li>
        <li className="font-semibold hover:text-[#009861] cursor-pointer mb-5 flex-nav-links ">
          <GiPlantSeed />
