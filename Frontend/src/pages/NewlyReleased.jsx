...
const CropCards = ({
  ...
  return (
    <section
      ...
      } rounded-md cursor-pointer group overflow-hidden`}
    >
      <div
      ...
      <div
        ...
        } pt-1 md:pt-2 group-hover:h-0 duration-150 ease-in overflow-hidden`}
      >
...
const NewlyReleased = () => {
  ...
  return (
    ...
    >
      <section className="w-[min(100%,1100px)] mx-auto mt-5 md:mt-10  min-h-[calc(600px)]">
        <div className="flex flex-col">
          ...
          <p className="text-base md:text-xl font-SegoeUI">
            Introducing our{" "}
            <span className="font-bold font-SegeoUIBold">
              newly released crops!
            </span>{" "}
            Discover and learn new crops. Whether you are an agricultural
            enthusiast, a farmer seeking new information, or a researcher, stay
            informed with updated and newly released crops.
          </p>
        </div>

        <aside className="flex items-start justify-center gap-4 flex-wrap mt-5 mb-5 md:mt-24 md:mb-7">
          {isLoading && <Loader />}
